...
class ArtsyNickApp(Application):
    ...
    def draw(self, ctx: Context) -> None:
        ...
        ctx.move_to(0, 0)
        ctx.save()
        ctx.scale(self._scale_cos, self._scale)
    ...
    def think(self, ins: InputState, delta_ms: int) -> None:
        ...
        self._scale_cos = math.cos(self._phase)
...
if __name__ == "__main__":
    st3m.run.run_view(ArtsyNickApp(ApplicationContext()))
